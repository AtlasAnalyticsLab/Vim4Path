...
if __name__ == '__main__':
    ...
    for lf in label_fracs:
        ...
        for i in range(args.k):
            ...
            save_splits(splits, ['train'], os.path.join(split_dir, 'splits_{}.csv'.format(i)))
            save_splits(splits, ['train'], os.path.join(split_dir, 'splits_{}_bool.csv'.format(i)), boolean_style=True)
